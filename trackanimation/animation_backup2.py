...
class AnimationTrack:
    ...
    def update_vorony_regions(self):
        ...
        colors_districts = cmap(np.linspace(0.0, 1.0, len(self.pointsVOR)))[:, :3]

        # ax.imshow(ma.img, aspect='equal', alpha=0.8)
        self.axarr[0].add_collection(mpl.collections.PolyCollection(cells, facecolors=colors_districts, edgecolors="k", alpha=0.25))
