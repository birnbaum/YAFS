...
def runMCDAR(pathRScript, pathWD, fileName, criteriaWeights, IndifferenceThresholds, PreferenceThresholds, VetoThresholds, minmaxcriteria):
    cmd = [
        "Rscript",
...
lp = np.percentile(data[:, 0], 20) / 3.0
...
output = runMCDAR(path, dname, "data", criteriaWeights, IndifferenceThresholds, PreferenceThresholds, VetoThreshold, criteriaMinMax)
