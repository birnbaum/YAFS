...
def runMCDAR(pathRScript, pathWD, fileName, ncriteria, criteriaWeights, categoriesLowerProfiles, criteriaMinMax, criteriaVetos, majorityThreshold):
    cmd = [
        "Rscript",
